...
public class PartnershipController {
    ...
    public ResponseEntity<Partnership> terminatePartnership(@PathVariable int id) {
        Partnership terminated = partnershipService.terminatePartnership(id);
    ...
    @PostMapping("/applyForPartnership/{entrepriseId}/{proposalId}")
    public Partnership applyForPartnership(@PathVariable int entrepriseId, @PathVariable int proposalId) {
    ...
    public List<Partnership> getByEntrepriseId(@PathVariable("id") int idEntreprise) {
        return partnershipService.getPartnershipsByEntrepriseId(idEntreprise);
    }

    @GetMapping("/by-user/{partnerId}")
    public ResponseEntity<List<Partnership>> getPartnershipsByPartnerId(@PathVariable int partnerId) {
        List<Partnership> partnerships = partnershipService.getPartnershipsByPartnerId(partnerId);
        if (partnerships.isEmpty()) {
            return ResponseEntity.noContent().build();
        }
        return ResponseEntity.ok(partnerships);
