...
public class EntrepriseController {
    ...
    //feignClientMethod
    @PostMapping("/AddEntrepriseandAssignToUserClient/{idUser}")
    public Entreprise addEntrepriseAndAffectToUserfeign(@RequestBody Entreprise ent, @PathVariable int idUser) {
        return serviceEntreprise.addEntrepriseAndAffectToUserClient(ent, idUser);
    }
    ...
    public int getEntrepriseIdByUserId(@PathVariable int partnerId){
        return serviceEntreprise.getEntrepriseIdByPartnerId(partnerId);
    }

    @GetMapping("/getPartner/{id}")
    public UserDTO getUserById(@PathVariable int id) {
        return serviceEntreprise.getUserById(id);
    }
